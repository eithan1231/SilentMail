...
// so full credits to them

class user_agent
{
  private $m_platform = null;
  private $m_browser = null;
   ...
   *    User agent string to parse or null. Uses $_SERVER['HTTP_USER_AGENT'] on NULL
   * @return string[]
   *    an array with browser, version and platform keys
   */
